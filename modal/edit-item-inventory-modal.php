...
<!-- Edit Item Modal -->
<div class="modal fade" id="editItemModal" data-bs-backdrop="true" tabindex="-1" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-4 position-relative">
                                ...
                                <input type="text" class="form-control" id="ingredientName" name="ingredientName" 
                                       required placeholder="Type ingredient name..." autocomplete="on"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control" id="threshold" name="threshold" 
                                       min="0" step="0.01" required placeholder="Enter threshold amount"
                                       style="border: 2px solid var(--primary-color); border-radius: 10px; 
                                              font-family: var(--secondaryFont); background: var(--card-bg-color);
                                              color: var(--text-color-dark); padding: 12px;">
                                <div class="form-text mt-2" 
